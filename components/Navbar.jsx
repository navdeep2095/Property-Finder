    ...
    <nav className='bg-blue-700 border-b border-blue-500'>
      ...
      {isMobileMenuOpen && (<div id='mobile-menu'>
        <div className='space-y-1 px-2 pb-3 pt-2'>
          ...
          <Link
            href='/properties'
            className={`${pathname === '/properties'? 'bg-black':''} text-white hover:bg-black-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
          >
            Properties
          </Link>
          {isLoggedIn && <Link
            href='/properties/add'
            className={`${pathname === '/properties/add'? 'bg-black':''} text-white hover:bg-black-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}
          >
            Add Property
          </Link>}
